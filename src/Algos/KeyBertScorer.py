...
class KeyBertScorer(SingletonMixin, ScorerBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.pharase_embedding_cache_tensor: "OrderedDict[str, torch.Tensor]" = (
            OrderedDict()
        )
    ...
    def build_keybert_cache(self) -> None:
        ...
        self.pharase_embedding_cache_tensor = cache
    ...
    def verify(
        ...
        # defensive checks
        if not self.pharase_embedding_cache_tensor or embedding_to_compare_with is None:
