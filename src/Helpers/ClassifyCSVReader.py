...
class ClassifyCSVReader:
    ...
    def __init__(
        ...
        *,
        ...
        if os.path.isabs(csvPath):
            ...
            cwdPath = os.path.normpath(os.path.join(os.getcwd(), csvPath))
            if os.path.isfile(cwdPath):
                self.csvPath: str = cwdPath
            else:
    ...
    def _queryWithSqlite(
        ...
        debugLevel = DebugHelper.level(self.cfg)
        ...
        if infoRows:
            ...
            self.pretty.write(
                "I", "ClassifyCSVReader", headerLine, color=GREEN, max_line_length=999
            )
            for dr in sortedRows:
                ...
                if queryCols:
                    ...
                    line += f"  |  {extras}"
                self.pretty.write(
                    "I", "ClassifyCSVReader", line, color=CYAN, max_line_length=999
                )
