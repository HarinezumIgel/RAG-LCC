...
# ---------------------------------------------------------------------------
# Add entries here to extend the baseline filter defined in Config_WebSearch.py.
# See Config_WebSearch.WEB_SEARCH_INTENT_EXTENSIONS for documentation of the
# available keys (entity_extensions, entity_categories_extra, threshold_overrides).
# ---------------------------------------------------------------------------
WEB_SEARCH_INTENT_EXTENSIONS: dict = {
    "entity_extensions": {},
